            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5 me-lg-auto">
                        <li class="nav-item"><a class="nav-link click-scroll" href="index.php">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="./home-medicine-requests.php">Medicine Requests</a></li>
                        <li class="nav-item"><a class="nav-link click-scroll" href="./home-medicine-offers.php">Medicine Offers</a></li>
                        <li class="nav-item"><a class="nav-link click-scroll" href="#section_3">About Us</a></li>
                        <li class="nav-item"><a class="nav-link click-scroll" href="#section_6">Q&A</a></li>
                        <li class="nav-item">
