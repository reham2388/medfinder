...
// Démarrer la session
session_start();
// Récupération de l'ID du patient connecté à partir de la session
...
try {
    ...
    if ($result_check_medicament && mysqli_num_rows($result_check_medicament) > 0) {
        ...
        $sql_insert_recherche = "INSERT INTO recherche (id_medicament, date_recherche, heure_recherche, quantite_recherche, satisfait, id_patient) VALUES ('$id_medicament', CURDATE(), CURTIME(), '$quantite_recherche', 0, '$id_patient')";
