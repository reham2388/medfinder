                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="./patient-medicine-requests.php">Medecine Requests</a>
                            </li>
    ...
    <table class="table table-striped table-hover">
        ...
        if ($result) {
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<tr><td colspan='4' class='text-center text-danger'>No result found</td></tr>";
            }
        } else {
    ...
    $('.satis-button').click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response == 'success') {
                    alert('Medication marked as satisfied');
